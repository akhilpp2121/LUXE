...
import {
  ...
  offerEdit,
  offerToggle,
} from "../controller/adminOfferController.js";
...
import {
  ...
  getAnalyticsPage,
} from "../controller/adminAnalysticController.js";
...
router.patch(
  "/orders/:id/items/:variantId/status",
  isAdminAuth,
  updateOrderItemStatus,
);
...
router.get("/analystic", isAdminAuth, getAnalyticsPage);
router.get("/analystic/excel", isAdminAuth, downloadAnalyticsExcel);
router.get("/analystic/pdf", isAdminAuth, downloadAnalyticsPdf);
